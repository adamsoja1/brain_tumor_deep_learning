...
def multi_unet_model(n_classes, IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS):
    ...
    c44 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(p4)
    c44 = Dropout(0.3)(c44)
    c44 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c44)
    p44 = MaxPooling2D(pool_size=(2, 2))(c44)
    
    
    
    c5 = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(p44)
    c5 = Dropout(0.5)(c5)
    c5 = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c5)
    
    u66 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same')(c5)
    u66 = concatenate([u66, c44])
    c66 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(u66)
    c66 = Dropout(0.3)(c66)
    c66 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c66)
    
    #Expansive path 
    u6 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same')(c66)
